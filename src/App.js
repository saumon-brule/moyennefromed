  ...
  return (
    <>
      {!token && <div onClick={BTCprice} style={{ textAlign: "left", marginTop: "1%", marginLeft: "1.5%" }}>
        <input type="button" value="prix BTC" style={{ fontSize: "0.8em", color: "white", background: "none", width: "15%", minWidth: 93, borderWidth: "3px", borderStyle: "solid", borderColor: "#eef7ff", borderRadius: "15px", outline: "none", cursor: "pointer" }} />
      </div>}
